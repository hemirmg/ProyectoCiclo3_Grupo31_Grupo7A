...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header bg-danger text-white">
            <h5 class="modal-title">Desea eliminar el usuario?</h5>
            <button class="close" data-dismiss="modal">
                <span>&times;</span>
            </button>
        </div>
        <br>
        <form action="${pageContext.request.contextPath}/Usuarios?accion=eliminar&cedulaUsuario=${param.cedulaUsuario}" method="POST" class="was-validated  centrado">
