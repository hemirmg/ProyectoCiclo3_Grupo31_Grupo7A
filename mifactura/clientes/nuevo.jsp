<div class="modal fade" id="nuevoClienteModal"> <!-- id viene desde atributo data-target="#nuevoUsuarioModal" en el boton nuevo-->
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title"><i class="fas fa-mug-hot"></i> Agregar Cliente</h5>
            ...
            <br>
            <!-- Formulario Nuevo-->
            <form action="${pageContext.request.contextPath}/Clientes?accion=nuevo" method="POST" class="was-validated">
                <section id="details">
                    <div class="container">
                        <div class="row">
                            <div class="col">
